    ...
    return (
        <>
            ...
            <main className="w-full bg-surface min-h-screen py-8">
                <div
                    className="w m-auto flex flex-col gap-lg lg:w"
                    style={{
                        "--w": "94%",
                        "--w-lg": "80%"
                    }}
                >
                    <section className="w-full flex flex-col gap-md md:flex-row md:items-end md:justify-between">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted mt-2">
                                ...
                                participación ciudadana y fuentes
                                de tráfico.
                            </p>
                        </div>
                    ...
                    {error ? (
                        <section className="card text-center">
                            ...
                            <p className="text-sm text-muted mt-2">
                                {error?.message ||
                                    "Verifica la función RPC y los permisos de Supabase."}
                            </p>
                        ...
                        <>
                            <section className="w-full grid grid-cols-1 gap-md sm:grid-cols-2 xl:grid-cols-4">
                                {metrics.map(item => (
                                    <article
                                        key={item.label}
                                        className="card card-kpi"
                                    >
                                        <p className="card-kpi-label">
                                            {item.label}
                                        </p>

                                        <p className="card-kpi-value">
                                            {loading
                                                ? "—"
                                                : item.value}
                                        </p>

                                        <p className="card-kpi-description">
                                            {item.description}
                                        </p>
                                    </article>
                                ))}
                                ...
                                <article className="card lg:col-span-2">
                                    <div className="card-header">
                                        <div>
                                            <h2 className="card-title">
                                                Conversión de Pulso Ciudadano
                                            </h2>

                                            <p className="card-description">
                                                Usuarios que iniciaron y
                                    ...
                                    <div className="w-full grid grid-cols-1 gap-md md:grid-cols-2">
                                        ...
                                        <div className="border rounded-md p-md bg-white">
                                            ...
                                            <div
                                                className="w-full bg-surface rounded-full overflow-hidden mt-md"
                                                style={{
                                                    height: "10px"
                                                }}
                                            >
                                    ...
                                    <div className="card card-subtle mt-md">
                                        ...
                                        <p className="text-sm text-muted mt-2">
                                            ...
                                            comienzan Pulso Ciudadano,
                                            aproximadamente{" "}
                                            <strong>
                                                {completionRate}
                                            </strong>{" "}
                                            terminan el cuestionario.
                                        </p>
                                    </div>
                                </article>
                            ...
                            <section className="card">
                                ...
                                <div className="w-full grid grid-cols-1 gap-sm sm:grid-cols-2 lg:grid-cols-4">
                                    <Link
                                        ...
                                        className="border rounded-md p-md bg-white"
                                    >
                                        <p className="text-sm font-medium">
                                            Pulso Ciudadano
                                        </p>
                                    ...
                                    <button
                                        type="button"
                                        className="border rounded-md p-md bg-white text-left"
                                        onClick={refresh}
                                    >
                                        <p className="text-sm font-medium">
                                            Actualizar datos
